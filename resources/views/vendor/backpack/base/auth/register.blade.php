                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control{{ $errors->has('nom') ? ' is-invalid' : '' }}" name="nom" id="nom" value="{{ old('nom') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control{{ $errors->has('prénom') ? ' is-invalid' : '' }}" name="prénom" id="prénom" value="{{ old('prénom') }}">
